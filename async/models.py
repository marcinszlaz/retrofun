...
# relationship objects
    ...
    countries: Mapped[list['Country']] = relationship(
                lazy='selectin', secondary='products_countries',
...
# relationship objects
    product: Mapped['Product'] = relationship(lazy='joined',
        innerjoin=True, back_populates='order_items')
...
# columns
    ...
    user_id: Mapped[UUID] = mapped_column(ForeignKey('blog_users.id'),
                                          index=True)
# relationship objects
    user: Mapped['BlogUser'] = relationship(lazy='joined',
        innerjoin=True, back_populates='sessions')
